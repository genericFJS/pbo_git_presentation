...
\begin{frame}[fragile]
	...
	\commentm{m1}{{\visible<1->{hallo m1}}};
	\commentb{b1}{{\visible<2->{hallo b1}}};
	\commentb{b2}{{\visible<3->{hallo b2}}};
	\commentm{m2}{{\visible<4->{hallo m2}}};
	\commento{o1}{{\visible<5->{hallo o1}}};
	\commentb{b3}{{\visible<6->{hallo b3}}};
	\commentm{m3}{{\visible<7->{hallo m3}}};
	\commentm{m4}{{\visible<8->{hallo m4}}};
	\commentm{m5}{{\visible<9->{hallo m5}}};
	\end{tikzpicture}
