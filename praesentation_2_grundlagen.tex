...
\begin{frame}[fragile]
	...
	\commentb{b1}{{\visible<2->{\textcolor{htwblue}{Lukas} erstellt branch von \textcolor{htwgrey}{Master} + commit}}};
%	\commentb{b2}{{\visible<3->{}}};
%	\commentm{m2}{{\visible<4->{}}};
	\commento{o1}{{\visible<3->{\textcolor{htworange}{Johanna} erstellt branch von \textcolor{htwblue}{Lukas} + commit}}};
%	\commentb{b3}{{\visible<6->{}}};
	\commentm{m3}{{\visible<4->{\textcolor{htwgrey}{Master} merged seinen branch mit \textcolor{htwblue}{Lukas} branch}}};
	\commentm{m4}{{\visible<5->{\textcolor{htwgrey}{Master} merged seinen branch mit \textcolor{htworange}{Johannas} branch}}};
